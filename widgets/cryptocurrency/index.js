        ...
        coins.forEach((coin) => {
            document.getElementById("coins-list").appendChild(
              <div class="d-flex justify-content-between p-1">          
                <div class="p-1" style="font-weight:bold;"><img class="p-1" style="width: 28px;" onerror={"this.src='" + __dirname + "/defaultcoin.png'"} src={"https://cryptoicons.org/api/icon/"+ coin.symbol.toLowerCase() +"/20"} /> {coin.name}</div>
                <div class="p-1">
